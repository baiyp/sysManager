var TableDatatablesManaged = function () {
	...
	var initTable3 = function () {
        ...
        table.dataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": WebUtil.getMainRoot()+"/queryEnterprise?userinfo=1",//userinfo 0 表示普通企业用户  1企业VIP用户
            "displayStart": 0,
            "pageLength": 10,
            "lengthMenu": [
                [6, 15, 20, -1],
            ...
            "columnDefs": [
                         ...
                         {"targets":[0],
                          ...
                          },
                          {
                             ...
                             "searchable": false,
                             render: function (data,full, meta ) { 
                            	 return "<button data-target=\"#ajax\" data-toggle=\"modal\" href=\"enterpriseDetail.html\" class=\"btn btn-sm green btn-outline audit-submit margin-bottom\" dataUrl="+meta.id+" ><i class=\"fa fa-hand-pointer-o\"></i>详情</button> <button class=\"btn btn-sm red btn-outline forbidden-submit\" dataUrl="+meta.id+"|"+meta.username+"><i class=\"fa fa-times\"></i> 禁用</button>";
                             }
                         }
